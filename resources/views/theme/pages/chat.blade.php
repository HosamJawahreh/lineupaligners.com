                            ...
                            <ul class="m-b-0">
                                ...
                                <li>
                                    ...
                                    <div class="message my-message">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-4 m-t-10"><a href="javascript:void(0);"><img src="{{ asset('assets/images/image2.jpg') }}" alt="" class="img-fluid img-thumbnail"></a> </div>
                                            <div class="col-sm-6 col-lg-4 m-t-10"><a href="javascript:void(0);"> <img src="{{ asset('assets/images/image3.jpg') }}" alt="" class="img-fluid img-thumbnail"></a> </div>
                                            <div class="col-sm-6 col-lg-4 m-t-10"><a href="javascript:void(0);"> <img src="{{ asset('assets/images/image4.jpg') }}" alt="" class="img-fluid img-thumbnail"> </a> </div>
                                        </div>
                                    </div>
                                </li>                        
                                <li>
