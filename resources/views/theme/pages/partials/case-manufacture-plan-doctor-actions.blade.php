...
<section class="mfg-plan__doctor-actions" aria-label="Doctor actions for this stage">
    <div class="mfg-plan__doctor-actions-head">
        <div>
            ...
            <p class="mfg-plan__doctor-actions-lead">Review the plan below, then approve for manufacture or order a modification with notes and optional scans.</p>
        </div>
        <div class="mfg-plan__review-actions mfg-plan__review-actions--prominent">
            <form method="post"
                  ...
                  class="mfg-plan__review-form mfg-plan__review-form--approve-only"
    ...
    <p class="mfg-plan__doctor-actions-note">
        ...
        <strong>Order Modification</strong> opens the Request Modification tab — add required notes there and upload new scans or photos if needed.
    </p>
</section>
@endif
