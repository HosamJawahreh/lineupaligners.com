        ...
        <div class="row clearfix">
            <div class="col-lg-4 col-md-12">
                <div class="card project_widget">
                        <div class="pw_img">
                        <img class="img-fluid" src="{{ asset('assets/images/image2.jpg') }}" alt="About the image">
                    </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card project_widget">
                    <div class="pw_img">
                        <img class="img-fluid" src="{{ asset('assets/images/image4.jpg') }}" alt="About the image">
                    </div>                            
                    <div class="pw_content">
                        <div class="pw_header">
                            <h6>New Dashboard</h6>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card project_widget">
                        <div class="pw_img">
                        <img class="img-fluid" src="{{ asset('assets/images/image3.jpg') }}" alt="About the image">
                    </div>
                    <div class="pw_content">
                        <div class="pw_header">
                            <h6>Mobile App</h6>
                    ...
                    <div class="body">
                        <ul class="new_friend_list list-unstyled row">
                            <li class="col-lg-4 col-md-2 col-sm-6 col-4">
                                <a href="">
                                    <img src="{{ asset('assets/images/sm/avatar1.jpg') }}" class="img-thumbnail" alt="User Image">
                            ...
                            <li class="col-lg-4 col-md-2 col-sm-6 col-4">
                                <a href="">
                                    <img src="{{ asset('assets/images/sm/avatar2.jpg') }}" class="img-thumbnail" alt="User Image">
                            ...
                            <li class="col-lg-4 col-md-2 col-sm-6 col-4">
                                <a href="">
                                    <img src="{{ asset('assets/images/sm/avatar3.jpg') }}" class="img-thumbnail" alt="User Image">
                            ...
                            <li class="col-lg-4 col-md-2 col-sm-6 col-4">
                                <a href="">
                                    <img src="{{ asset('assets/images/sm/avatar4.jpg') }}" class="img-thumbnail" alt="User Image">
                            ...
                            <li class="col-lg-4 col-md-2 col-sm-6 col-4">
                                <a href="">
                                    <img src="{{ asset('assets/images/sm/avatar5.jpg') }}" class="img-thumbnail" alt="User Image">
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card-group text-center">
                    <div class="card">
                        <img class="img-fluid" src="{{ asset('assets/images/image2.jpg') }}" alt="Card image cap">
                        <div class="body">
                    ...
                    <div class="card">
                        <img class="img-fluid" src="{{ asset('assets/images/image3.jpg') }}" alt="Card image cap">
                        <div class="body">
                            <h4 class="title">Card title</h4>
                    ...
                    <div class="card">
                        <img class="img-fluid" src="{{ asset('assets/images/image1.jpg') }}" alt="Card image cap">
                        <div class="body">
                            <h4 class="title">Card title</h4>
                        ...
                        <ul class="inbox-widget list-unstyled clearfix">
                            <li class="inbox-inner"> <a href="javascript:void(0)">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{ asset('assets/images/xs/avatar1.jpg') }}" class="rounded" alt=""> </div>
                            ...
                            <li class="inbox-inner"> <a href="javascript:void(0)">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{ asset('assets/images/xs/avatar2.jpg') }}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"> <a href="javascript:void(0)">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{ asset('assets/images/xs/avatar3.jpg') }}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"> <a href="javascript:void(0)">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{ asset('assets/images/xs/avatar4.jpg') }}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"> <a href="javascript:void(0)">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{ asset('assets/images/xs/avatar5.jpg') }}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
