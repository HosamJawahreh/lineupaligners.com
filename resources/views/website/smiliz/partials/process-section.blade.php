...
<section @class([
    ...
    <div class="lineup-process-section__atmosphere" aria-hidden="true">
        <span class="lineup-process-section__orb lineup-process-section__orb--1"></span>
        <span class="lineup-process-section__orb lineup-process-section__orb--2"></span>
        <span class="lineup-process-section__grid"></span>
    </div>
    ...
    <div class="container lineup-process-section__container position-relative">
        ...
        <div class="lineup-process-showcase" data-step-count="{{ count($processSteps) }}">
            ...
            <div class="lineup-process-showcase__tour" data-aos="fade-up" data-aos-duration="700">
...
@once
@push('scripts')
<script src="{{ asset('assets/js/lineup-process-section.js') }}?v=6" defer></script>
@endpush
@endonce
