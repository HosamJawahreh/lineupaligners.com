...
<section class="pbmit-bg-color-secondary bottom-radius transform-top-sec portfolio-section-two lineup-cases-section" id="cases">
    <div class="container" data-aos="fade-up" data-aos-duration="800">
        <div class="swiper-slider lineup-cases-swiper" data-autoplay="true" data-loop="{{ count($portfolioItems) > 2 ? 'true' : 'false' }}" data-dots="true" data-arrows="true" data-columns="2" data-allow-touch="false" data-margin="30" data-effect="slide">
