...
return [
    ...
    'group_hints' => [
        ...
        'services' => 'Why LineUp overview and feature detail pages.',
    ...
    /** Icons for public header navigation (pbmit-base-icon-* for a consistent formal set). */
    'nav_icons' => [
        'home' => 'ti-home',
        'groups' => [
            'about' => 'pbmit-base-icon-user-1',
            'services' => 'pbmit-base-icon-star-1',
            'case_study' => 'pbmit-base-icon-gallery',
            'blog' => 'pbmit-base-icon-label',
            'faq' => 'pbmit-base-icon-comment-alt',
            'contact' => 'pbmit-base-icon-phone-1',
        ],
        'pages' => [
            'about-us' => 'pbmit-base-icon-user-1',
            ...
            'faq' => 'pbmit-base-icon-comment-alt',
            'service-details' => 'pbmit-base-icon-star-1',
            ...
            'contact-us-01' => 'pbmit-base-icon-phone-1',
